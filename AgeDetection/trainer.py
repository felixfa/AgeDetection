...
from AgeDetection.utils import load_images_from_folder, \
                                load_image_data_into_dataframe
...
if __name__ == "__main__":
    ...
    X_train, X_test, y_train, y_test, y_train_cat, y_test_cat = \
        split_data(X, y, test_size=0.2, random_state=42, clear_mem=True)
    print("Split Done\n")
